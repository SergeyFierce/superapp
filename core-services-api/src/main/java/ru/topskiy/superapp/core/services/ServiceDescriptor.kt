...
/**
 * Абстрактный тип иконки сервиса.
 *
 * В Android-приложении это обычно ImageVector или Painter,
 * на других платформах может быть любой представимый тип.
 */
typealias ServiceIcon = Any
